...
- `isUndefinedOdds` / `toEuro` / `toHK` / `toMalay` / `malayToHK` — the odds conversion chain (Fair Probability ⇄ Euro ⇄ HK ⇄ Malay), including the sign-based inverse used by 4.2's spread.
